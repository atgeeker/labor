...
public class ExcelUtil<T> {
	 ...
	 *            java输出流
	 */
	public OutputStream exportExcel(List<T> list, String sheetName, int sheetSize, OutputStream output) {
	...
	public void cell(HttpServletResponse response, HttpServletRequest request, OutputStream out, String fileName)
			throws Exception {
